...
Notes:
    1.10. 2020
    Creates centerlines on user imported glacier outlines and DEM. 
    
    1.10.2020
    Seems to work with python 3.6 and latest OGGM build (MacOS)
...
# out fp
out_fp = r'/Users/apj/Documents/_HY/Greenland/centerlines/edited_glacier_divides/centerlines_50s_edited_08102020.shp'
...
# read shapefile
fp = r'/Users/apj/Documents/_HY/Greenland/outlines/edited_glacier_divides/05_rgi60_studyarea_50s_extent_wgs84_edited.shp'

entity = gpd.read_file(fp)

# test with one glacier
#entity = entity[entity['RGIId'] == 'RGI60-05.02319_1']
...
#f, ax = plt.subplots()
#da_user = xr.open_rasterio(gdirs[0].get_filepath('dem'))
...
#graphics.plot_catchment_areas(gdirs)
